ActionController::Routing::Routes.draw do |map|
  ...
  map.connect 'api/v1/analytics/final_scores', :conditions => { :method => :get }, :controller => 'analytics_api', :action => 'final_scores', :format => 'json'
  map.connect 'api/v1/analytics/final_scores/courses/:course_id', :conditions => { :method => :get }, :controller => 'analytics_api', :action => 'course_final_scores', :format => 'json'
  map.connect 'api/v1/analytics/final_scores/courses/:course_id/users/:user_id', :conditions => { :method => :get }, :controller => 'analytics_api', :action => 'course_user_final_scores', :format => 'json'
